...
Logger.prototype._applySerializers = function (fields, excludeFields) {
    ...
    Object.keys(this.serializers).forEach(function (name) {
        ...
        try {
            ...
            var serializer = self.serializers[name];
            ...
            // Log all intervals
            console.log('Gaps between operations:');
            console.log('Start->Lookup:', (t1[0] - t0[0]) * 1e9 + (t1[1] - t0[1]));
            console.log('Lookup->LookupEnd:', (t2[0] - t1[0]) * 1e9 + (t2[1] - t1[1]));
            console.log('LookupEnd->FieldStart:', (t3[0] - t2[0]) * 1e9 + (t3[1] - t2[1]));
            console.log('FieldStart->FieldEnd:', (t4[0] - t3[0]) * 1e9 + (t4[1] - t3[1]));
            console.log('FieldEnd->SerializeStart:', (t5[0] - t4[0]) * 1e9 + (t5[1] - t4[1]));
            console.log('SerializeStart->SerializeEnd:', (t6[0] - t5[0]) * 1e9 + (t6[1] - t5[1]));
            console.log('SerializeEnd->AssignStart:', (t7[0] - t6[0]) * 1e9 + (t7[1] - t6[1]));
            console.log('AssignStart->AssignEnd:', (t8[0] - t7[0]) * 1e9 + (t8[1] - t7[1]));
            console.log('Total:', (t8[0] - t0[0]) * 1e9 + (t8[1] - t0[1]));
            console.log('=== End ===');
        } catch (err) {
