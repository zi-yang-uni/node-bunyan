...
Logger.prototype._applySerializers = function (fields, excludeFields) {
    Object.keys(this.serializers).forEach(function (name) {
        // Log the actual serializer function being called
        console.log('Serializer for %s:', name, self.serializers[name].toString());
        
        var lookupStart = process.hrtime();
        var serializer = self.serializers[name];  // Get serializer function
        var lookupTime = process.hrtime(lookupStart);
        console.log('Serializer lookup took:', lookupTime[0] * 1e9 + lookupTime[1]);
        ...
        console.log('Actual serialization took:', serializeTime[0] * 1e9 + serializeTime[1]);
    });
}
