...
function mkRecord(log, minLevel, args) {
    ...
    if (recFields) {
        ...
        if (log.serializers) {
            console.log('Err serializer:', this.serializers.err.toString());
            console.log('Req serializer:', this.serializers.req.toString());
            console.log('Res serializer:', this.serializers.res.toString());
